...
object FormRelatedString{
    ...
    const val ExpectedSales = "Expected sales revenue based on current stock"
    const val ExpectedProfit = "Expected gross profit amount based on current stock"
    const val ExpectedProfitPercentage = "Expected gross profit percentage(%)"
    ...
    const val RevenuePercentageAsDebt = "Revenue percentage(%) as debt"
    const val RevenuePercentageAsExpense = "Revenue percentage(%) as expense"
    ...
    const val DayWithHighestRevenue = "Day with highest revenue"
    const val DayWithHighestExpense = "Day with highest expense"
    const val DayWithLowestRevenue = "Day with lowest revenue"
    const val DayWithLowestExpense = "Day with lowest expense"
