...
object FormRelatedString{
    ...
    const val ExpectedProfitPercentage = "Expected gross profit %"
    const val MostAvailableItem = "Most available inventory item"
    ...
    const val SavingsBalance = "Savings balance"
    const val OutstandingDebt = "Outstanding debt"
    const val NetIncome = "Net Income withdrawals"
    const val TotalWithdrawals = "Total withdrawals"
    const val NumberOfItemCategories = "Number of item categories"
    const val NumberOfItemManufactures = "Number of item manufacturers"
    const val RevenuePercentageAsDebt = "Revenue % as debt"
    const val RevenuePercentageAsExpense = "Revenue % as expense"
    const val TotalNumberOfHours = "Number of hours opened"
    const val AverageHoursPerDay = "Average hours opened per day"
    const val NumberOfDaysOpened = "Number of days opened"
    const val AverageDailyRevenue = "Average daily revenue"
    const val AverageDailyExpense = "Average daily expense"
    const val AverageHourlyRevenue = "Average hourly revenue"
    const val TotalRevenues = "Total revenues"
    const val TotalExpenses = "Total expenses"
    ...
    const val MaxRevenueAmount = "Max revenue amount"
    const val MinRevenueAmount = "Min revenue amount"
    const val MaxExpenseAmount = "Max expense amount"
    const val MinExpenseAmount = "Min expense amount"
    const val DayWithHighestRevenue = "Max revenue day"
    const val DayWithHighestExpense = "Max expense day"
    const val DayWithLowestRevenue = "Min revenue day"
    const val DayWithLowestExpense = "Min expense day"
    ...
    const val EnterNumberOf = "Enter number of "
