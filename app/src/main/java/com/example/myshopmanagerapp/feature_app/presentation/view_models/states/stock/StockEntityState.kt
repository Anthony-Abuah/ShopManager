...
data class StockEntityState (
    val stockEntity: StockEntity? = StockEntity(0, emptyString, LocalDate.now().toTimestamp(), emptyString, emptyString, emptyString, emptyList(),0, LocalDate.now().toTimestamp(), 0,0.0, 0.0,false, null),
